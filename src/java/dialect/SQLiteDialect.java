...
public class SQLiteDialect extends Dialect {
  ...
  public String appendIdentitySelectToInsert(String insertString) {
    ...
    private static class SQLiteLimitHandler extends AbstractLimitHandler {
        ...
        /**
         * Default constructor. SQL query and selection criteria required to
         * allow LIMIT clause pre-processing.
         *
         * @param sql SQL query.
         * @param selection Selection criteria. {@code null} in case of
     ...
     *
     * @param sql SQL query.
     * @param selection Selection criteria. {@code null} in case of unlimited
     * number of rows.
